...
class _SettingScreenState extends LasyRenderingState<SettingsScreen> {
  static final bool _showLegacyIsp = bool.fromEnvironment(
    'moneyfly.showLegacyIsp',
  );
  static final bool _showLegacyHtmlBoard = bool.fromEnvironment(
    'moneyfly.showLegacyHtmlBoard',
  );
  static final bool _showLegacyAppleTV = bool.fromEnvironment(
    'moneyfly.showLegacyAppleTV',
  );
  ...
  Future<List<GroupItem>> getGroupOptions() async {
    ...
    if (_showLegacyIsp && remoteISPConfig.id.isNotEmpty) {
      String expireTime = "";
      bool expiring = false;
      String ispUser = "";
    ...
    // MoneyFly manages account, traffic, help links and rulesets in the backend.
    ...
    if (_showLegacyHtmlBoard && !settingConfig.novice) {
      groupOptions.add(GroupItem(options: [
        GroupItemOptions(
            pushOptions: GroupItemPushOptions(
    ...
    // Profiles are downloaded automatically after MoneyFly login.
    ...
    if (_showLegacyAppleTV && PlatformUtils.isMobile()) {
      groupOptions.add(GroupItem(options: [
        GroupItemOptions(
            pushOptions: GroupItemPushOptions(
