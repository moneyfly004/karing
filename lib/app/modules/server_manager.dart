...
import 'package:karing/features/moneyfly/moneyfly_config_crypto.dart';
...
class ServerManager {
  ...
  static Future<void> saveServerConfig() async {
    ...
    if (_serverConfig.items.any(
        (item) => item.remark == MoneyflyAccountController.managedRemark)) {
      content = await MoneyflyConfigCrypto.encrypt(content);
    }
