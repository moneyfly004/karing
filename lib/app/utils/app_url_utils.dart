...
abstract final class AppUrlUtils {
  static String getQueryParamsForAnalytics(int bodyLen) {
    return _encodeQueryParams(AppUtils.getBuildinVersion(), bodyLen, {});
  }
  ...
  static Future<String> getQueryParamsForUrl(int bodyLen) async {
    ...
    return _encodeQueryParams(AppUtils.getBuildinVersion(), bodyLen, params);
  }

  static String _encodeQueryParams(
      String version, int bodyLen, Map<String, dynamic> params) {
